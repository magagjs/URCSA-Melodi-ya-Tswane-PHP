...
(function($) {
     ...
     $.fn.tipuesearch = function(options) {
          ...
          'contentLocation'        : 'js/tipuesearch_content.json',
          'contextBuffer'          : 60,
          'contextLength'          : 60,
          'contextStart'           : 90,
          'debug'                  : false,
          ...
          return this.each(function() {
               ...
               $.ajaxSetup({
                    async: false	// MyT Changes:2018/05/29: https://xhr.spec.whatwg.org/: Developers must not pass false for the async argument when current global object is a Window object.
               });
               ...
               if (getURLP('search'))
               {
                    $('#search-box-input').val(getURLP('search'));
               ...
               function getTipueSearch(start, replace)
               {
                    ...
                    if (d.length >= set.minimumLength)
                    {
                         ...
                         if (c != 0)
                         {
                              ...
                              if (c > set.show)
                              {
                                   ...
                                   out += '<nav aria-label="Search Page navigation"><div id="tipue_search_foot"><ul class="pagination" id="tipue_search_foot_boxes">';
                                   
                                   if (start > 0)
                                   {
                                       out += '<li><a class="tipue_search_foot_box" accesskey="b" id="' + (start - set.show) + '_' + replace + '">' + tipuesearch_string_6 + '</a></li>'; 
                                   }
                                   ...
                                   if (page <= 2)
                                   {
                                        ...
                                        for (var f = 0; f < p_b; f++)
                                        {
                                             if (f == page)
                                             {
                                                  out += '<li class="current active"><a href="#">' + (f + 1) + '</a></li>';
                                             }
                                             else
                                             {
                                   ...
                                   if (page + 1 != pages)
                                   {
                                       out += '<li><a class="tipue_search_foot_box" accesskey="m" id="' + (start + set.show) + '_' + replace + '">' + tipuesearch_string_7 + '</a></li>'; 
                                   }                    
                    ...
                    {
                         $('#search-box-input').val($(this).attr('id'));
                         getTipueSearch(0, true);
                    });                
